            ...
            <div id="header">
                <div class="bg">
                    <div class="jumbotron jumbotron-fluid">
                        <h1 class="display-1" id="top">Settings</h1>
                    </div>
                </div>
            </div>
            <div class="content">
                            ...
                            <div class="row">
                                <div class="col-md-7 mb-3">
                                    <label for="address">Address</label>
                                        <input type="text" class="form-control" id="address" placeholder="" value="B.N.M.I.T Campus, Banshankari, Bangalore - 560072" disabled>
                                </div>
                            </div>
                            <hr class="md-4" />
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="cc-num" id="cc-number" placeholder="" value="<?=$cc_num_db?>" required pattern="[0-9]{16}" title="Please enter 16 digits">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <label for="cc-expiration"> Card Expiry Date</label>
                                        <input type="text" class="form-control" name="exp" id="cc-expiration" placeholder="" value="<?=$exp_db?>" required pattern="(?:0[1-9]|1[0-2])/[0-9]{2}" title="Data format incorrect. Please enter in MM/YY format only">
                                </div>
                                <div class="col-md-3 mb-3">
