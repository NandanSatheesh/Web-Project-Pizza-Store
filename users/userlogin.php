        ...
        <div class="bg">
            <div class="jumbotron jumbotron-fluid">
                <div class="container-fluid" id="header">
                    <div class="row">
                        <h1 class="display-1">Pizza ASAP!</h1>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="display-4">Delivery to B.N.M. Institute of Technology Only</h2>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container-fluid" id="loginCardContainer">
                <div class="card card-block">
                    <div class="card-title">
                        <h3 class="card-header card-header-portrait">Login</h3><h3 class="card-header card-header-landscape">Pizza ASAP!</h3>
                    </div>
                    <div class="container-fluid">
                        ...
                        <div class="row text-center">
                            <div class="col-md-12">
                                <p>
                                    <span class="text-muted">For Staff Login, <a href="../admin/adminlogin.php">Click Here</a></span>.
                                </p>
                            </div>
                        </div>
                    </div>
