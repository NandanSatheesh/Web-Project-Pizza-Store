<?php
    ...
    if(isset($_POST["name"])) {
        ...
        while($row = $res->fetch_assoc()) {
            $email = $row["email"];
            $testo = "The menu has been updated!";
            $tipo = 2;
            $nuova = true;
            ...
            <div id="header">
                <div class="bg">
                    <div class="jumbotron jumbotron-fluid">
                        <h1 class="display-1" id="top">Add to the menu</h1>
                    </div>
                </div>
            </div>
            <div id="content">
                        ...
                        <div class="row newline">
                            ...
                            <div class="col-md-8">
                                <div class="input-group mb-3">
                                  ...
                                  <input type="number" class="form-control" step="0.01" id="price" min = "0" name="price" placeholder="EUR" aria-label="prezzo" aria-describedby="currency" required="">
                                </div>
                            </div>
                        </div>
