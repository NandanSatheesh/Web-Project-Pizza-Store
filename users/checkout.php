            ...
            <div class="d-flex flex-row order-2 order-md-2 justify-content-end">
                <ul class="navbar-nav flex-row">
                    <li class="nav-item">
                        ...
                        <a class="btn btn-link nav-link active" href="#top" id="cart-link">View Cart and Checkout <span class="fas fa-shopping-cart" id="cart-icon"></span><span class="<?=$hidden?> badge badge-pill badge-danger" id="cart-count"><?= $cart_items ?></span></a>
                    </li>
                </ul>
                        ...
                        <div class="col-md-8 order-md-1">
                          ...
                          <form class="needs-validation" action="order.php" method="post" novalidate="">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="address" name="address" value="B.N.M.I.T., Banshankari,Bangalore - 560070" disabled>
                              <div class="invalid-feedback">                  
