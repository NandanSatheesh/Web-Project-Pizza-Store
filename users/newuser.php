<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") 
    {
        ...
        if (isset($_POST['password'])) {
            ...
            } elseif (preg_match("/^(.{0,7}|[^0-9]*|[^A-Z]*|[^a-z]*|[a-zA-Z0-9]*)$/", $password)) {
                $err .= "The password must be at least 8 characters and contain at least one lowercase letter, an uppercase letter, a number and a special character\n";
            }
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address" class="form-control" id="address"  value="B.N.M.I.T., Banshankari, Bangalore - 560070" disabled>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-left-border">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-append">
                                                    <input type="password" name="password" class="form-control" id="password" value="" pattern=".{8,}" required title="Atleast 8 characters"><span class="fa fa-check" style="color:green;" aria-hidden="true"></span>
                                                    </div>
                                                </div>
                                                <small id="passwordHelpText" class="form-text text-muted">
                                                At least 8 characters, at least one capital letter, at least one symbol and at least one number.</small>
                                                <div class="form-group">
                                                    <label for="pwd_ok">Confirm Password</label>
                                                    <div class="input-group-append">
                                                        <input type="password" name="password_ok" class="form-control" id="pwd_ok" value="" pattern=".{8,}" required title="Atleast 8 characters"><span class="fa fa-check" style="color:green;" aria-hidden="true"></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
