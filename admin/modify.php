            ...
            <div id="header">
                <div class="bg">
                    <div class="jumbotron jumbotron-fluid">
                        <h1 class="display-1" id="top">Modify the Menu</h1>
                    </div>
                </div>
            </div>
            <div id="content">
                      ...
                      <div class="row newline">
                          ...
                          <div class="col-md-8">
                              <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" step="0.1" min="0" id="price" name="price" required placeholder="EUR" aria-label="prezzo" aria-describedby="currency">
                              </div>
                          </div>
                      </div>
